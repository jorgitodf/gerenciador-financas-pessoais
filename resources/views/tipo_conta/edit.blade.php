...
@section('title', 'Edição de Tipo de Conta')
        ...
        <div class="row">
            <div class="col-md-7 col-md-offset-3 col-sm-7 col-sm-offset-3 col-xs-7 col-xs-offset-3">
                <div class="well well-sm sombra" id="div_cad_tpconta">
                    <form class="form-horizontal" role="form" action="{{ route('tipo-conta.atualizar') }}" method="post" id="formCadTipoConta" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <fieldset>
                        @include('tipo_conta._form')
                            ...
                            <div class="form-group">
                                <div class="col-md-9 col-md-offset-3 col-sm-9 col-sm-offset-3 text-left">
                                    <button type="button" class="btn btn-primary btn-md" id="btn-edit-tpconta">Editar</button>
                                    <button type="submit" class="btn btn-primary btn-md" id="btn-salvar-tpconta" disabled>Salvar</button>
