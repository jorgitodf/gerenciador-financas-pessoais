        ...
        <div class="row">
            <div class="col-md-7 col-md-offset-3 col-sm-7 col-sm-offset-3 col-xs-7 col-xs-offset-3">
                <div class="well well-sm sombra">
                    <form class="form-horizontal" role="form" action="{{route('banco.atualizar')}}" method="post" id="formCadBanco" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <fieldset>
                        @include('banco._form')
                        ...
                        <!-- Form actions -->
                            <div class="form-group">
                                <div class="col-md-9 col-md-offset-3 col-sm-9 col-sm-offset-3 text-left">
                                    <button type="button" class="btn btn-primary btn-md" id="btn-edit-bnc">Editar</button>
                                    <button type="submit" class="btn btn-primary btn-md" id="btn-salvar-bnc" disabled>Salvar</button>
                                </div>
                            </div>
