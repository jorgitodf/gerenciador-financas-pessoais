    ...
    <div class="form-group">
        ...
        <div class="col-md-8">
            <input id="nome_banco" name="nome_banco" type="text" placeholder="Nome do Banco" class="form-control white remove-color-input" value="{{isset($banco->nome_banco) ? $banco->nome_banco : ''}}" disabled="disabled">
